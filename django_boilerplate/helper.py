...
from .temlplate_id import DJANGO_BOILERPLATE_TEST_TEMPLATE_ID
...
# Example dynamic_data_for_template = {
            #     'subject': 'Testing the SendGrid HTML templte Email',
            #     'message':'Hello, Successfully sent the SendGrtid template email'
            # }
...
def send_html_template_email(to_email, sendgrid_temlpate_id, dynamic_data_for_template):
    ...
    mail = Mail()
    mail.from_email = Email("akash.citrusbug@gmail.com")
