"""
Define all your core util functions here.
"""
...
# from core.models.channel_category import ChannelCategory
# from core.models.live_streaming_category import LiveStreamingCategory
# from core.models.podcast_category import PodcastCategory
...
def admin_urlname(value, arg):
    ...
    if value.model_name == 'groupinvitation':
        ...
        pattern = "%s-%s" % (value.model_name, arg)
...
def filter_superadmin():
    """Filter SuperUser from the User list"""
...
def filter_admin():
    """Filter Staff members from the User list"""
    return User.objects.exclude(
        is_staff=True
    )
...
def filter_vendor():
    """Filter Vendors from the User list"""
...
def filter_podcast_category():
    """Filter category 'All' from the Podcast Category list"""
    return PodcastCategory.objects.exclude(title__iexact="all")


def filter_live_stream_category():
    """Filter category 'All' from the Live Stream Category list"""
    return LiveStreamingCategory.objects.exclude(title__iexact="all")


def filter_channel_category():
    """Filter category 'All' from the Channel Category list"""
    return ChannelCategory.objects.exclude(title__iexact="all")
