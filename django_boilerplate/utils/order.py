# """
# Define Order related stuff here.
# """
...
#     """This method is used to create a response object of a bank"""
...
#     # pay_method = stripe.createPaymentMethod()
#     # pay_id = pay_method.id
#     # newcustomer = stripe.createCustomer(user, pay_id)
#     # User.objects.filter(pk=user.id).update(customer_id=newcustomer.id, pay_method_id=pay_id)
#     return newcustomer
