...
SOCIAL_AUTH_APPLE_ID_SECRET = env.str('SOCIAL_AUTH_APPLE_ID_SECRET')
...
REST_AUTH_SERIALIZERS = {
    'JWT_SERIALIZER': 'apps.api.serializers.rest_auth.JwtSerializer',
}

REST_AUTH_REGISTER_SERIALIZERS = {
    "REGISTER_SERIALIZER": 'apps.api.serializers.rest_auth.RegisterSerializer'
}
