...
# @register.inclusion_tag("partials/input_tags.html")
# def input_tags(field):
#    return {
#         "field": field,
#     }

@register.inclusion_tag("partials/list_boolean.html")
def show_check(value):
    return {"bool_val": value}


@register.inclusion_tag("partials/list_lock.html")
def show_lock(value):
    return {"bool_val": value}


@register.inclusion_tag("partials/input_datetime_bootstrap.html")
...
@register.inclusion_tag("partials/input_date_bootstrap.html")
...
@register.inclusion_tag("partials/input_icheck.html")
def input_icheck(field):
    """Return HTML markup for a icheck checkbox."""
    return {"field": field}


@register.inclusion_tag("partials/input_upload_video.html")
...
@register.inclusion_tag("partials/input_upload_image.html")
...
@register.inclusion_tag("partials/input_upload_file.html")
...
# @register.filter
# def index(i):
#     languages = Language.objects.filter().order_by('id')
#     return languages[i]
