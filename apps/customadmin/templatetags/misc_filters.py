...
def admin_urlname(value, arg):
    ...
    if value.model_name == 'mediacategory':
        pattern = "%s:%s-%s" % ('customadmin', 'mediacategory', arg)     
    if value.model_name == 'mediaimage':
        pattern = "%s:%s-%s" % ('customadmin', 'mediaimage', arg) 
    if value.model_name == 'mediavideo':
        pattern = "%s:%s-%s" % ('customadmin', 'mediavideo', arg) 
