...
def admin_urlname(value, arg):
    ...
    if value.model_name == 'group':
        pattern = "%s:%s-%s" % ('customadmin', 'group', arg) 
    if value.model_name == 'groupuser':
        pattern = "%s:%s-%s" % ('customadmin', 'groupuser', arg)
    if value.model_name == 'notification':
        pattern = "%s:%s-%s" % ('customadmin', 'notification', arg)
    if value.model_name == 'blog':
        pattern = "%s:%s-%s" % ('customadmin', 'blog', arg)
    if value.model_name == 'blogkeyword':
        pattern = "%s:%s-%s" % ('customadmin', 'blogkeyword', arg)
